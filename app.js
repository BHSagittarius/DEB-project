...
// window.storage(shared:false) est propre à chaque page ouverte séparément,
// donc on s'appuie surtout sur un cookie (qui suit le navigateur d'une page à l'autre),
// avec window.storage en secours si le cookie n'est pas disponible.
let myName = '';
